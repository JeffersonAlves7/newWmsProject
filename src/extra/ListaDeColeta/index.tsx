...
export default function ListaDeColeta() {
  ...
  const str = `/pedidos?itens=true&idLista=${id}${nf !== undefined ? `&nf=${nf}` : ""}`
    ...
    <div className="flex flex-col gap-2 items-center">
      <header className="flex justify-evenly items-center">
        <div className="flex items-center justify-center flex-col">
          <h1 className="text-lg font-semibold">{nf === undefined ? "ID da Lista de Coleta:" : "Id da Lista de Coleta  Única:"} {id}</h1>
